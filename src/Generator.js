      ...
      <section className="generator">
        ...
        <div className="btn-container">
          <div className="parts">
            ...
            {keys.map((key, index) => {
              if(part === key){
                return <button className="btn-parts" key={index} style={{color: "white", background: colors[changePart.backgrounds], border: `1px solid ${colors[changePart.backgrounds]}`}} value={key} onClick={(e) => handleClickPart(e)}>{key}</button>
              }else {
                 if(hover === key){
                   return <button className="btn-parts" style={hoverStyle} key={index} value={key} onClick={(e) => handleClickPart(e)} onMouseEnter={(e) => handleMouseEnter(e)} onMouseLeave={() => setHover('')}>{key}</button>
                 }else{
                   return <button className="btn-parts" style={nonHoverStyle} key={index} value={key} onClick={(e) => handleClickPart(e)} onMouseEnter={(e) => handleMouseEnter(e)} onMouseLeave={() => setHover('')}>{key}</button>
                 }
              }
          ...
          <div className="style">
            ...
            {data[part].map((style, index) => {
              if(part === "backgrounds"){
                return <button className="btn-parts" key={index} style={{color: colors[style], background: colors[style], border: colors[style]}} value={style} onClick={(e) => handleClickStyle(e)}>yellow60</button>
              }else{
              if(changePart[part] === style){
                return <button className="btn-parts" key={index} style={{color: "white", background: colors[changePart.backgrounds], border: `1px solid ${colors[changePart.backgrounds]}`}} value={style} onClick={(e) => handleClickStyle(e)}>{style}</button>
              }else {
                 if(hover === style){
                   return <button className="btn-parts" style={hoverStyle} key={index} value={style} onClick={(e) => handleClickStyle(e)} onMouseEnter={(e) => handleMouseEnter(e)} onMouseLeave={() => setHover('')}>{style}</button>
                 }else{
                   return <button className="btn-parts" style={nonHoverStyle} key={index} value={style} onClick={(e) => handleClickStyle(e)} onMouseEnter={(e) => handleMouseEnter(e)} onMouseLeave={() => setHover('')}>{style}</button>
                 }
              }
            ...
            <div className="randown-container">
              <button className="btn-parts randown" onClick={() => handleRandom()}>Random</button>
              <button className="btn-parts randown" onClick={() => handleDownload()}>Download</button>
            </div>
        </div>
      </section>
    </main>
